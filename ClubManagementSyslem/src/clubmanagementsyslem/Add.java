...
public class Add extends JFrame implements ActionListener{
    ...
    JTextField tfname, tffname, tfaddress, tfphone, tfnic, tfemail, tffee, tfdesignation;
    JDateChooser dcdob;
    ...
    Add() {
        ...
        String courses[] = {"Fsc","BBA", "BCA", "BA", "BSC", "B.COM", "BTech", "MBA", "MCA", "MA", "MTech", "MSC", "PHD"};
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == add) {
            ...
            try {
                Conn conn = new Conn();
                String query = "insert into player values('"+name+"', '"+fname+"', '"+dob+"', '"+fee+"', '"+address+"', '"+phone+"', '"+email+"', '"+education+"', '"+designation+"', '"+nic+"', '"+Id+"')";
